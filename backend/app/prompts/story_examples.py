...
IMPORTANT: action and dialogue fields must match the PDF's screenplay
texture exactly — multiple fragment sentences, rapid-fire dialogue
exchanges, "Beat." pacing devices. Do NOT compress into paragraphs.
    ...
    "scenes": [
        {
            ...
            "setting_id": "loc_1",
            "action": "BLACKOUT.\nTotal darkness.\nThey collide hard in the kitchen doorway.\nThey freeze inches apart. Breathing.\nNeither moves away.",
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "They both reach blindly.\nTheir hands hit the same drawer.\nShe yanks the drawer open.\nSilence. Sharp.",
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "The lighter sparks.\nLight floods her face.\nIt lands.\nHe stares at her.\nWounded. Furious.\nSilence detonates between them.",
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "Neither moves.\nThe candle flickers between them.\nTheir breathing syncs unintentionally.\nBut he doesn't step away.",
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "Her hand shakes.\nThe candle tips. Rolls.\nHe grabs it. Stops it.\nHis hand closes over hers.\nElectric.\nNeither planned it.\nNeither lets go.",
            "dialogue": None,
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "They don't separate.\nShe pulls him forward.\nThey kiss.\nImmediate. Violent. Inevitable.\nThen\u2014\nShe shoves him back.",
        ...
        },
        {
            ...
            "characters_on_screen": ["kate", "ryan"],
            "setting_id": "loc_1",
            "action": "She backs away. Breathing hard.\nSomething hits the floor.\nHe looks down.\nThe candlelight reveals\u2014\nA medical envelope.\nHer name.\nOBSTETRICS.\nHe looks up.\nShe freezes.\nHard cut to black.",
            "dialogue": "RYAN: Kate\u2026",
    ...
    "scenes": [
        {
            ...
            "setting_id": "loc_1",
            "action": "Crystal chandeliers. Champagne. Power everywhere.\nAlexandra enters. Alone.\nAcross the room\u2014\nMax freezes mid-laugh.\nHe wasn't expecting her.\nHe disengages immediately.\nPredator focus.\nMoves toward her.",
            "dialogue": None,
        ...
        },
        {
            ...
            "setting_id": "loc_1",
            "action": "Vanessa clings tighter to his arm.\nAlexandra holds eye contact.\nBeat.",
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max"],
            "setting_id": "loc_1",
            "action": "He adjusts his cuff.\nHe leans closer.\nHe watches for damage.",
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max"],
            "setting_id": "loc_1",
            "action": "Alexandra doesn't flinch.\nBeat.\nSilence.\nMax blinks.\nThen laughs.",
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max", "vanessa"],
            "setting_id": "loc_1",
            "action": "Vanessa smirks.\nSecurity begins drifting closer.\nQuiet. Final.",
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max"],
            "setting_id": "loc_1",
            "action": "The lights dim.\nA microphone crackles.\nMax doesn't break eye contact.\nCertain of his dominance.\nSpotlight ignites.\nDirectly on Alexandra.",
            "dialogue": None,
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max", "vanessa"],
            "setting_id": "loc_1",
            "action": "Applause detonates.\nMax's smile collapses.\nVanessa releases his arm.\nSecurity stops moving.\nMax's champagne glass slips\u2014\nSHATTERS.",
            "dialogue": None,
        ...
        },
        {
            ...
            "characters_on_screen": ["alexandra", "max"],
            "setting_id": "loc_1",
            "action": "Alexandra steps toward the stage.\nStops beside Max.\nLeans in.\nQuiet. Only for him.\nShe walks away.\nMax stands frozen.\nDestroyed.\nHard cut to black.",
    ...
    "scenes": [
        {
            ...
            "setting_id": "loc_1",
            "action": "The throne room doors slam open.\nSoldiers drag Elira inside.\nShe struggles.\nShe freezes.\nShe recognizes the voice.",
        ...
        },
        {
            ...
            "characters_on_screen": ["elira", "varos"],
            "setting_id": "loc_1",
            "action": "Varos sits on a throne that doesn't belong to him.\nDragon skull above his head.\nHe studies her.",
        ...
        },
        {
            ...
            "characters_on_screen": ["elira", "varos"],
            "setting_id": "loc_1",
            "action": "He grabs her wrist.\nTurns it upward.\nA faint glowing mark burns beneath her skin.\nGasps from the soldiers.\nBeat.\nShe whispers\u2014",
        ...
        },
        {
            ...
            "characters_on_screen": ["elira", "varos"],
            "setting_id": "loc_1",
            "action": "Silence swallows the room.\nVaros stares at the mark.\nHungry.\nShe meets his eyes.\nNo fear now.",
        ...
        },
        {
            ...
            "characters_on_screen": ["elira", "varos"],
            "setting_id": "loc_1",
            "action": "Varos tightens his grip on her wrist.\nThe throne room trembles harder.\nStone cracking.",
        ...
        },
        {
            ...
            "characters_on_screen": ["elira", "varos"],
            "setting_id": "loc_1",
            "action": "A massive shadow passes over the throne room.\nSoldiers look up.\nTerrified.\nA deafening DRAGON ROAR splits the sky.\nVaros slowly looks back at her.\nShe smiles.\nHard cut to black.",
            "dialogue": None,
