                ...
                {narratorTab === "ai" ? (
                  ...
                  <>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 h-[279px] bg-[#16151D] rounded-xl flex items-center justify-center">
                        <button
                    ...
                    <div className="flex items-center justify-between mt-6">
                      <div className="flex items-center gap-6">
                        {/* Audio Player */}
                        <div className="flex items-center gap-3 px-2 py-1 bg-[#16151D] rounded-lg" style={{ width: 636 }}>
                          <button className="w-8 h-8 flex items-center justify-center">
                            <svg width="12" height="14" viewBox="0 0 12 14" fill="white">
                              <path d="M0 0L12 7L0 14V0Z"/>
                            </svg>
                          </button>
                          <div className="flex-1 h-[5px] bg-[#272726] rounded-full relative">
                            <div className="absolute left-0 top-0 w-[82px] h-full bg-[#5C5C5B] rounded-full"/>
                          </div>
                          <span className="text-white text-base" style={{ fontFamily: "Mulish" }}>0:00 / 1:28</span>
                        </div>
