...
import { getCreatorShareUrl } from "@/lib/share-urls";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mt-5 md:mt-6">
        ...
        {/* Share button — always shares clean profile URL (no query params) */}
        <ShareButton
          url={getCreatorShareUrl(profile.username)}
          title={`${profile.name} on Oddega`}
